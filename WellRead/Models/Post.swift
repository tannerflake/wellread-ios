...
struct Post: Identifiable, Codable {
    ...
    static let demoFeed: [Post] = {
        ...
        return [
            Post(id: UUID(), userId: User.demo.id, type: .finishedBook, bookId: b.id, book: b, caption: "Just finished. Highly recommend.", createdAt: Date(), likeCount: 4, commentCount: 1, user: .demo)
        ]
    }()
}
